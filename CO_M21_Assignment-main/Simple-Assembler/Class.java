...
public class Class {
    ...
    static void check2(String[] arr){
        if(arr.length == 4) {
            ...
            else if(arr[1].charAt(0)=='R' && arr[2].charAt(0)=='R') CheckIf.ifC(arr);
            else if(Variable.var.contains(arr[2])) CheckIf.ifD(arr);
        }
        ...
        else if(arr[0].contains("label")){
            CheckIf.ifLabel(arr);
        }
    }

    static void output(){
        int l = Variable.var.size();
        boolean b = true;
        for(int i=0+l; i<Output.result.size(); i++){
...
class Assign{
    ...
    static void assignLabel(String[] args){
...
class CheckIf {
    ...
    static void ifC(String[] arr) {
        if (arr[1].length() == 2 && arr[2].length() == 2) {
            if (arr[1].charAt(0) == 'R' && arr[2].charAt(0) == 'R' && (arr[1].charAt(1) >= '0' && arr[1].charAt(1) <= '6') && (arr[2].charAt(1) >= '0' && arr[2].charAt(1) <= '6')) {
                switch (arr[0]) {
                    case "mov":
                    case "div":
                    case "not":
    ...
    static void ifLabel(String[] arr){
        String[] new_arr = Arrays.copyOfRange(arr, 1, arr.length);
        Class.check2(new_arr);
    }
